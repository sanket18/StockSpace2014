...
public class SubcategoryController {
	...
	protected static final String JSON_CONTENT = "application/json";
		...
		@ResponseBody 
		public String saveSubCategory(@RequestBody SubCategory subcategory, Model model )
		{
		...
		@RequestMapping(value="/deactivate/{subCategoryId}",method=RequestMethod.GET)
	 	public String deactivateSubCategory(@PathVariable("subCategoryId") int subCategoryId,RedirectAttributes ra, Model model){
			int deactivated;
	 	
	 		try {
	 			deactivated= subcategoryService.deactivateSubCategory(subCategoryId);
	 	...
	 	public String activateSubCategory(@PathVariable("subCategoryId") int subCategoryId,RedirectAttributes ra, Model model){
	 		int activated;
		...
		public String updateSubCategory(@ModelAttribute("subcategory") SubCategory subcategory,Model model)
		{			
